...
Hashtable test_options = (Hashtable)session.getAttribute("test_options");
...
String test_file_name = (String)session.getAttribute("test_file_name");
	...
	out.println("<table>");
		...
		while (keys.hasMoreElements())
		{
			...
			out.println("<TR>");
				...
				out.println("</B></TD>");
				out.println("<TD>");
				out.println("<input TYPE=\"text\" NAME=\"field"+test_i+"\" SIZE=\"25\" MAXLENGTH=\"30\">");
				out.println("</TD>");
			out.println("</TR>");
			test_i++;
