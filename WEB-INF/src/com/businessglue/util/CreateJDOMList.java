...
public class CreateJDOMList
{
	...
	*/
	...
	/**
	<p>This constructor is provided for servlet environments to enable logging.</p>
	<p>Logging notes:
			context = _context;
	...
	*/
	...
	/** 
	*<p>Returns a List of whater elements retrieved from the file with the passed
	* in string name.</p>*/
	...
	/**
	*<p>Get a list of text-definition strings which are children of a 'text' telement
	...
	*/
	...
	/**
	*<p>This method is similar to getTextDefHash, except that it filters the resutls
	...
	* replaced by org.catechis.JDOMSolution.
	<p>Im just adding an exclude mechanism to that words that have been tested recently can be excluded
	* from this list.
	...
	*/
	...
	/**
	*<p>THis method was replaced becuase it didn't work.  now the index is placed in the session
	...
	*/
	public Hashtable getWhateverHash(String elements, String names, String values)
	{
		...
		while (i<size)
		{
			...
			{
				context.log("CreateJDOMList.getWhateverHash: problem at "+i);
			}
			i++;
		}
		return options;
	...
	*/
	...
	/** 
	*<p>When this method gets called by the TestResultAction to record the scroe of a test,
	...
	* web apps when I wrote that.  When you arent using a db, recreating primary keys cant be
	* confusing.
	*/
	...
	*<p>We also update each individual word level dependent on type.<p>
