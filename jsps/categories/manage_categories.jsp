...
<TABLE>
  <TR>
    ...
    <TH><b><bean:message key="created_integrated_tests.name"/></b></TH>
    <TH><b><bean:message key="welcome.stats.number_of_words"/></b></TH>
  </TR>
...
+"</TH><TH><a href=\"/indoct/exclusive_category.do?category_id="+word_cat.getId()+"\">"+word_cat.getName()+"</a>"
...
<p>
<p><a href="/indoct/jsps/categories/add_type_category.jsp"><bean:message key="categories.add_category"/></a></p>
