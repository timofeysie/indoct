...
<body>
<h3><bean:message key="result.welcome.reading"/></h3>
<p>
<%
...
out.println("<table>");
	...
	{
		// Why dont we use the text value for the grades also?
		// For some reason we use the name original for the answer.  Go figure.
